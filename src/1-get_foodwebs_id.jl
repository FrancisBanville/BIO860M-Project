# In this script, we get the ID of all food webs archived on mangal.io and write them in a file for later use

## Read data from the mangal.io database

# query the id number and other (meta)data for all ecological networks archived on mangal.io
# id: network ID
...
## Filter for food webs (i.e. webs mainly having trophic links)
